...
public class QueryBuilder {
     ...
     * @return query string
     */
    public String cruiseQueryBuilder(HttpServletRequest request, int page, User user) {
        StringBuilder query =
                new StringBuilder(
                        "select * from cruises "
        ...
        Object leavingDate = request.getSession().getAttribute(FieldKey.CRUISE_LEAVING);
        ...
        Object arrivingDate = request.getSession().getAttribute(FieldKey.CRUISE_ARRIVING);
     ...
     * @return query string
     */
    public String cruiseCountQueryBuilder(HttpServletRequest request, User user) {
        StringBuilder query =
                new StringBuilder(
