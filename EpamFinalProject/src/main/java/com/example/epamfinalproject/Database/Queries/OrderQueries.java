...
public class OrderQueries {
    public static final String CREATE_ORDER_QUERY = "insert into orders(ship_id, user_id, status) values (?,?,?)";

    public static final String UPDATE_ORDER_BY_ID_QUERY = "update orders set ship_id = ?,user_id = ?,status = ? where id = ?";
    ...
    public static final String DELETE_ORDER_BY_SHIP_ID_QUERY = " delete from orders where ship_id = ?";
    ...
    public static final String GET_ORDER_BY_SHIP_ID = "select * from orders where ship_id = ?";
}
