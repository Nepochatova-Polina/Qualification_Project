...
public class Route_Implementation implements RouteDAO {
    ...
    public void createRoute(Route route) {
        ...
        try (Connection connection = connectionDB.getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement(CREATE_ROUTE_QUERY);
    ...
    public void updateRouteByID(long id, Route route) {
        ...
        try (Connection connection = connectionDB.getConnection()) {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement(UPDATE_ROUTE_QUERY);
            preparedStatement.setString(1, route.getDeparture());
            preparedStatement.setString(2, route.getDestination());
            preparedStatement.setInt(3, route.getDistance());
            preparedStatement.setInt(4, route.getTransitTime());
    ...
    public void deleteRouteByID(long id) {
        ...
        try (Connection connection = connectionDB.getConnection()) {
            connection.setAutoCommit(false);
            PreparedStatement preparedStatement = connection.prepareStatement(DELETE_ROUTE_QUERY);
    ...
    public Route findRouteByID(long id) {
        ...
        ConnectionDB connectionDB = ConnectionDB.getConnectionDB();
        try (Connection connection = connectionDB.getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement(ROUTE_BY_ID_QUERY);
            preparedStatement.setLong(1,id);
    ...
    public List<Route> findRouteByDeparture(String departure) {
        ...
        ConnectionDB connectionDB = ConnectionDB.getConnectionDB();
        try (Connection connection = connectionDB.getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement(FIND_ROUTE_BY_DEPARTURE_QUERY);
    ...
    public List<Route> findRouteByDestination(String destination) {
        ...
        ConnectionDB connectionDB = ConnectionDB.getConnectionDB();
        try (Connection connection = connectionDB.getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement(FIND_ROUTE_BY_DESTINATION_QUERY);
    ...
    public List<Route> findRouteByTransitTime(int transitTime) {
        ...
        ConnectionDB connectionDB = ConnectionDB.getConnectionDB();
        try (Connection connection = connectionDB.getConnection()){
            PreparedStatement preparedStatement = connection.prepareStatement(FIND_ROUTE_BY_TRANSIT_TIME_QUERY);
    ...
    public List<Route> findRouteByDepartureAndDestination(String departure, String destination) {
        ...
        ConnectionDB connectionDB = ConnectionDB.getConnectionDB();
        try (Connection connection = connectionDB.getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement(FIND_ROUTE_BY_DEPARTURE_AND_DESTINATION_QUERY);
            preparedStatement.setString(1, departure);
