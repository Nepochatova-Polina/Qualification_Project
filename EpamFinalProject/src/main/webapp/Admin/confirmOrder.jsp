    ...
    <table>
        ...
        <c:forEach var="order" items="${sessionScope.orders}">
            <tr>
                ...
                <td><h5><c:out value="${order.cruise.route.destination}"/></h5></td>
                <td><h5><c:out value="${order.cruise.route.transitTime}"/></h5></td>
                <td><h5><c:out value="${order.cruise.price}$"/></h5></td>
                <td><h5><c:out value="${order.cruise.startOfTheCruise}"/></h5></td>
                <td><h5><c:out value="${order.cruise.endOfTheCruise}"/></h5></td>
